...
> **Order** → **CNC (dropouts, junctions, stems)** → **Tube cutting** → **Adjustable jig** → **TIG tacking** → **Progressive TIG welding** → **Polishing** → **Epoxy painting** → **Assembly** → **Inspection + packaging**
