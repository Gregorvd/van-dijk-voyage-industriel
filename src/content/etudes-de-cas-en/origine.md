...
> **Customer configuration<br>(website)** → **Carbon frame retrieval/ordering** → **Individual painting (dedicated booth)** → **Component preparation (cart + customer sheet)** → **Assembly** → **Quality control** → **Delivery or factory pickup**
